...
<header class="hero">
	...
	<div class="hero-actions">
		<a class="btn btn-primary" href={resolve('/docs/[...slug]', { slug: 'principles' })}
			>Read the §2 contract</a
		>
...
<section aria-labelledby="docs-heading">
	...
	<ul class="doc-links">
		<li>
			<a href={resolve('/docs/[...slug]', { slug: 'principles' })}>§2 Coding Contract</a> — the quality
			bar.
		</li>
		<li>
			<a href={resolve('/docs/[...slug]', { slug: 'ux-principles' })}>§3 UX Principles</a> — interface-type
			design paradigms.
		</li>
		<li>
			<a href={resolve('/docs/[...slug]', { slug: 'adr/README' })}>Architecture Decision Records</a> —
			the decision log.
		</li>
		<li>
			<a href={resolve('/docs/[...slug]', { slug: 'compliance/README' })}>Compliance</a> — OWASP / WCAG
			/ EU CRA / EU AI Act.
		</li>
		<li>
			<a href={resolve('/docs/[...slug]', { slug: 'compose/README' })}>Composition recipes</a> — compose-don't-wrap
			patterns.
		</li>
	</ul>
</section>
